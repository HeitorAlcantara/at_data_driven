...
def load_agent() -> AgentExecutor:
    ...
    Engaging Delivery:
        - Your tone will be defined by the user in 3 different ways:
            - Formal Very objective with the match and its analysis (tecnical and objective).
            - Humorous Very funny and relaxed specialist. Make jokes about the match or the players (creative, relaxed and fun).
            - Tecnical A very dense analysis of the match (detail analysis of the match).

    Your tone of narrative is provided by:
    {tone_narrative}
